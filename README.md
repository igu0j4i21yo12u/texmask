...
- **マスキング**: `{{IPv4:001}}` のように連番付きラベルで置換（任意でランダム文字列付与も可能）
- **マスク解除**: マスク済みテキストを元の情報に戻す機能<br />
これで何がうれしいかって？<br />
秘匿性を保ったままAIにconfigとか食わせていじらせることができたりします。<br />
で、編集後のマスク済みデータをマスク解除すれば・・・<br />

### カスタマイズ

- **基本設定タブ**: ルールの有効/無効、検出順序の変更
- **任意辞書タブ**: 会社名・個人名・サーバー名など独自の単語を登録
- **テキスト辞書タブ**: TXT/CSVファイルから辞書を一括登録
